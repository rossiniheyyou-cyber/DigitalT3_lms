...
export default function InstructorDashboard() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold text-slate-800">Instructor Dashboard</h1>
        <p className="text-slate-500 mt-1">Manage courses, assessments, and learner progress</p>
      </div>
